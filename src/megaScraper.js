...
const getMessages = async (client, ChannelType, targetServerId, limit) => {
	...
	const excludedChannels = ['737631545270992917', '772750674072043522'];

	targetServer.channels.cache.forEach(async (channel) => {
		if (channel.type === ChannelType.GuildText && !excludedChannels.includes(channel.id)) {
